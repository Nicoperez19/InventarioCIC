...
Route::view('dashboard', 'layouts.dashboard.dashboard')->middleware(['auth', 'verified'])->name('dashboard');
Route::view('profile', 'layouts.profile.profile')->middleware(['auth'])->name('profile');
Route::view('users', 'layouts.user.user_index')->middleware(['auth'])->name('users');
Route::view('departamentos', 'layouts.departamento.departamento_index')->middleware(['auth'])->name('departamentos');
Route::view('unidades', 'layouts.unidad.unidad_index')->middleware(['auth'])->name('unidades');
Route::view('productos', 'layouts.producto.producto_index')->middleware(['auth'])->name('productos');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/carga-masiva', [\App\Http\Controllers\CargaMasivaController::class, 'upload'])->name('carga-masiva.upload');
