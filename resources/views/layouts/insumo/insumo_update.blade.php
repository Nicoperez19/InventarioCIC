    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Modifica la información del insumo {{ $insumo->nombre_insumo }}</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('insumos.update', $insumo->id_insumo) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" value="{{ $insumo->id_insumo }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 text-gray-500" 
                                       disabled>
                                <p class="text-xs text-gray-500 mt-1">El ID del insumo no se puede modificar</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Código de Barras</label>
                                <input type="text" name="codigo_barra" value="{{ old('codigo_barra', $insumo->codigo_barra) }}" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nombre_insumo" value="{{ old('nombre_insumo', $insumo->nombre_insumo) }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-dark-teal focus:border-dark-teal" 
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="stock_actual" value="{{ old('stock_actual', $insumo->stock_actual) }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-dark-teal focus:border-dark-teal" 
