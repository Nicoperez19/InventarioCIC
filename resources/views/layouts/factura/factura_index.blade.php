<x-app-layout>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center space-x-3 sm:space-x-4">
                <div class="flex-shrink-0">
                    <div
                        class="flex items-center justify-center w-8 h-8 rounded-lg sm:w-10 sm:h-10 bg-gradient-to-br from-primary-400 to-primary-500">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="hidden mt-1 text-xs text-gray-600 sm:text-sm sm:block">Administra y organiza las facturas
                        del sistema</p>
                </div>
            </div>
    ...
    <x-modal name="upload-factura" title="Subir Factura" maxWidth="2xl">
        <form id="upload-factura-form" method="POST" action="{{ route('facturas.upload') }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="archivo"
                                class="flex flex-col items-center justify-center w-full h-32 transition-colors border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
