    ...
    <div class="py-8">
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('unidades.update', $unidad->id_unidad) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" value="{{ $unidad->id_unidad }}" 
                                       ...
                                       disabled>
                                <p class="text-xs text-gray-500 mt-1">El ID de la unidad no se puede modificar</p>
                            </div>
