        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-3 sm:space-x-4">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 mt-1 hidden sm:block">Modifica la información de la unidad {{ $unidad->nombre_unidad_medida }}</p>
                </div>
            </div>
        </div>
    </x-slot>
            ...
            <div class="p-4 bg-white shadow sm:p-8 sm:rounded-lg">
                <form method="POST" action="{{ route('unidades.update', $unidad->id_unidad) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Actualiza el identificador y nombre de la unidad de medida</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" value="{{ $unidad->id_unidad }}" 
