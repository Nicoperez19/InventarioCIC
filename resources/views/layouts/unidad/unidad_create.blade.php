        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-3 sm:space-x-4">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 mt-1 hidden sm:block">Crea una nueva unidad de medida en el sistema</p>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <form method="POST" action="{{ route('unidades.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre_unidad_medida" value="{{ old('nombre_unidad_medida') }}" 
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-primary-400 transition-colors" 
