    ...
    <div class="w-full overflow-x-auto">
        ...
        <thead class="bg-gray-50">
            ...
            @forelse($proveedores as $proveedor)
                    <tr wire:key="proveedor-{{ $proveedor->id }}" class="hover:bg-light-cyan/10 transition-colors duration-150">
                        ...
                        <td class="w-2/12 px-3 sm:px-6 py-4">
                            <div class="text-sm text-neutral-600 pl-6">{{ $proveedor->facturas_count ?? 0 }}</div>
                        </td>
                        <td class="w-2/12 px-3 sm:px-6 py-4">
                            <div class="text-sm text-neutral-600 pl-6">${{ number_format($proveedor->facturas_sum_monto_total ?? 0, 0, ',', '.') }}</div>
                        </td>
                ...
                <tr>
                        <td class="px-3 sm:px-6 py-12 text-center" colspan="6">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-neutral-500">Comienza creando tu primer proveedor para organizar tu sistema.</p>
                            </div>
                        </td>
                </tr>
            @endforelse
